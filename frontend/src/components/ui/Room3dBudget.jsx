...
export const Room3DBudget = ({
    ...
    return (
        <div className="w-full">
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-b border-orange-300 p-4 rounded-t-xl">
            ...
            <div
                ref={containerRef}
                style={{ height: "600px" }}
                className="w-full shadow-xl border-b border-orange-200"
            />
